...
public class TestStockOptionParser3 {
    ...
    public void test_option_prices() {
        ...
        assertThat(options.size()).isEqualTo(60);
    ...
    public void test_normalize_ticker() {
        String validTicker = stockOptionParser.elementToTicker("Norway EQNR3C428.99Z");
        assertThat(validTicker).isNotNull();
        assertThat(validTicker).isEqualTo("EQNR3C428.99Z");
        validTicker = stockOptionParser.elementToTicker("Norway YAR2F470");
        assertThat(validTicker).isNotNull();
